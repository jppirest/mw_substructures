...
#modulo_teorico = 5*np.log10(987) - 5 #DIAS
#idade_teorica = 8.3 #DIAS
modulo_teorico = 10.05 #CANTAT
idade_teorica = 8.2 #CANTAT
...
def regressao_aglomerado(n_sigma):
    x = XAglo
    y = YAglo
    ...
    f.write( str(coefs_ms[0]) + ', ' + str(coefs_ms[1]) + ', ' + str(coefs_erro_ms[0]) + ', ' + str(coefs_erro_ms[1]) + ', ' + str(minimo_cor) + '\n')
    f.close()
